...
function preload() {
    ...
    // game.load.image('super_mario', 'assets/tilemaps/tiles/super_mario.png');
    // game.load.image('kenny_ground', 'assets/tilemaps/tiles/kenny_ground_64x64.png');
...
function create() {
    ...
    // ship = game.add.sprite(200, 200, 'cokecan');
    // game.physics.enable(ship, Phaser.Physics.ARCADE);

    // game.camera.follow(ship, FOLLOW_TOPDOWN_TIGHT);
